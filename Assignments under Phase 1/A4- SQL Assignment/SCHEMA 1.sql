...
DROP TABLE IF EXISTS CARTON CASCADE;
DROP TABLE IF EXISTS ORDER_HEADER CASCADE;
DROP TABLE IF EXISTS ONLINE_CUSTOMER CASCADE;
...
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (1,'Jennifer','Wilson','jen_w@gmail.com',9776363306,909,TO_DATE('01-JUN-91', 'DD-MON-YY'),'jen_w','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (2,'Jackson','Davis','dave_jack@gmail.com',9886363307,910,TO_DATE('12-JUN-01', 'DD-MON-YY'),'dave_jack','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (3,'Komal','Choudhary','ch_komal@yahoo.co.IN',9178234526,911,TO_DATE('26-JUN-02', 'DD-MON-YY'),'komalc','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (4,'Wilfred','Jean','w_jean@gmail.com',9196257439,912,TO_DATE('12-JAN-06', 'DD-MON-YY'),'jeanw','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (6,'Anita','Goswami','agoswami@gmail.com',9873245623,914,TO_DATE('13-MAR-06', 'DD-MON-YY'),'anitag','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (7,'Ashwathi','Bhatt','ash_bhat@yahoo.co.IN',9773636307,915,TO_DATE('15-APR-07', 'DD-MON-YY'),'abhatt','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (8,'Neetha','Castelina','neetha20@gmail.com',8196236362,916,TO_DATE('16-AUG-11', 'DD-MON-YY'),'cneeta','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (9,'Devika','Satish','devika_sa@gmail.com',9780945716,917,TO_DATE('01-SEP-11', 'DD-MON-YY'),'sdevika','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (10,'Bidhan','C.Roy','bidhanroy@yahoo.co.in',9886218583,918,TO_DATE('23-OCT-11', 'DD-MON-YY'),'bcroy','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (11,'Vikas','Jha','vikas.jha@gmail.com',9008812436,919,TO_DATE('15-NOV-11', 'DD-MON-YY'),'vjha','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (12,'Arul','Kumar.T','arulkumar@gmail.com',9902179894,920,TO_DATE('03-DEC-11', 'DD-MON-YY'),'akumar','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (13,'Ravi','Srinivasn','r_srinivasn@yahoo.co.in',9945466015,921,TO_DATE('05-JAN-12', 'DD-MON-YY'),'ravisri','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (14,'Avinash','Dutta','avinash.dutta@yahoo.co.in',9845100228,922,TO_DATE('18-JAN-12', 'DD-MON-YY'),'avdutta','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (15,'Jyoti','Sinha','jyotisinha@gmail.com',9987795155,923,TO_DATE('31-JAN-12', 'DD-MON-YY'),'jyo_s','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (16,'Vijay','Bollineni','vbollineni@gmail.com',7829012228,924,TO_DATE('06-FEB-12', 'DD-MON-YY'),'vbolli','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (17,'Prasad','Shetty','pshetty@yahoo.co.in',9731497821,925,TO_DATE('26-FEB-12', 'DD-MON-YY'),'shetty','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (18,'Suresh','Babu','sbabu@yahoo.co.in',9845969216,926,TO_DATE('01-MAR-12', 'DD-MON-YY'),'babu_s','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (19,'Bharti','Subhash','bhartis@gmail.com',9886870414,927,TO_DATE('28-MAR-12', 'DD-MON-YY'),'bha_subh','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (20,'Keshav','Jog','kesjog@yahoo.co.in',7942536789,928,TO_DATE('06-APR-12', 'DD-MON-YY'),'jog_kes','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (5,'Ramya','Ravinder','ramya_r23@gmail.com',7732341567,913,TO_DATE('12-FEB-06', 'DD-MON-YY'),'rramya','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (21,'Alan','Silvestri','alan_silver@msn.com',9450465464,930,TO_DATE('04-FEB-16', 'DD-MON-YY'),'asilvestri','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (22,'Andrew','Stanton','andrew_stanton@yahoo.com',9806980253,931,TO_DATE('23-MAY-13', 'DD-MON-YY'),'astanton','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (23,'Anna','Pinnock','anna_pinnock@yahoo.com',8540548103,932,TO_DATE('18-JAN-13', 'DD-MON-YY'),'apinnock','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (24,'Brian','Grazer','brian_grazer@gmail.com',7599462567,933,TO_DATE('28-DEC-09', 'DD-MON-YY'),'bgrazer','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (25,'Bruno','Delbonnel','bruno_delbonnel@msn.com',9016687652,934,TO_DATE('27-AUG-12', 'DD-MON-YY'),'bdelbonnel','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (26,'Stephen','E. Rivkin','stephen_e. rivkin@msn.com',9860111721,935,TO_DATE('04-MAR-10', 'DD-MON-YY'),'srivkin','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (27,'Mali','Finn','mali_finn@yahoo.com',7373475035,936,TO_DATE('14-JAN-06', 'DD-MON-YY'),'mfinn','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (28,'Sayyed','Faraj','sayyed_faraj@gmail.com',8556784235,937,TO_DATE('01-NOV-09', 'DD-MON-YY'),'sfaraj','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (29,'Francine','Maisler','francine_maisler@gmail.com',8440046170,938,TO_DATE('01-SEP-13', 'DD-MON-YY'),'fmaisler','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (30,'Anita','Kohli','anita_kohli@yahoo.com',8631526613,939,TO_DATE('24-OCT-10', 'DD-MON-YY'),'akohli','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (31,'Thomas','Newman','thomas_nman@yahoo.com',9539300577,940,TO_DATE('30-JUN-15', 'DD-MON-YY'),'tnewman','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (32,'Hans','Zimmer','hans_zimmer@yahoo.com',8338774317,941,TO_DATE('24-JAN-16', 'DD-MON-YY'),'hzimmer','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (33,'Niseema','Zimmer','niseemaz@yahoo.com',8179413840,941,TO_DATE('29-DEC-14', 'DD-MON-YY'),'ntalli','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (34,'Hans','Zimmer','hans_zimmer@gmail.com',9477272235,943,TO_DATE('27-SEP-15', 'DD-MON-YY'),'hzimmer2','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (35,'Thomas','Newman','thomas_newman@gmail.com',9526577840,944,TO_DATE('16-JAN-14', 'DD-MON-YY'),'tnewman2','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (36,'Michelle','H. Shores','howard_shores@yahoo.com',8795007592,945,TO_DATE('24-JUN-10', 'DD-MON-YY'),'mshores','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (37,'James','Newton Howard','james_nhoward@yahoo.com',9520246368,946,TO_DATE('06-JUL-12', 'DD-MON-YY'),'jhoward','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (38,'John','Lasseter','john_lass@gmail.com',9876356288,947,TO_DATE('02-SEP-16', 'DD-MON-YY'),'jlasseter','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (39,'Liz','Mullane','liz_mullane@gmail.com',7859695387,948,TO_DATE('29-MAR-06', 'DD-MON-YY'),'lmullane','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (40,'Paul','Haggis','paul_haggis@gmail.com',8332681111,949,TO_DATE('31-AUG-16', 'DD-MON-YY'),'phaggis','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (41,'Tharman','Shanmugaratnam','tharshan@yahoo.co.sg',8572898929,950,TO_DATE('20-NOV-09', 'DD-MON-YY'),'tshanmugaratnam','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (42,'Rebecca','Lim','reblim@msn.co.sg',8272438365,951,TO_DATE('31-JUL-09', 'DD-MON-YY'),'rlim','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (43,'Rajiv','Chandrasekaran','rajiv_chan@yahoo.co.in',7431699965,952,TO_DATE('14-APR-14', 'DD-MON-YY'),'rchan','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (44,'Tanya','Chua','tanyac@singers.sg',5435935345,953,TO_DATE('14-APR-14', 'DD-MON-YY'),'tchua','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (45,'Janvi','Rajiv','janvi_jha@msn.co.sg',8324529953,952,TO_DATE('14-APR-15', 'DD-MON-YY'),'jrajiv','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (46,'Tan Bee','Soo','tanbeesoo@yahoo.co.sg',8293092259,954,TO_DATE('15-NOV-16', 'DD-MON-YY'),'tsoo','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (47,'Yun','Zhu','yunzho@gmail.com',9407380992,955,TO_DATE('15-NOV-16', 'DD-MON-YY'),'yzhu','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (48,'Wajdi bin Abdul','Majeed','wajdiabdul@gmail.com',9380937709,956,TO_DATE('25-JUN-10', 'DD-MON-YY'),'wabdul','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (49,'Anbara binti','Mubarak','anmubarak@yahoo.co.my',7885803452,957,TO_DATE('27-AUG-10', 'DD-MON-YY'),'amubarak','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (50,'Sri binti ','Yaakob','sribinti@yahoo.co.my',8193579391,958,TO_DATE('18-DEC-07', 'DD-MON-YY'),'sribinti','F');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (51,'Ahmad Bin Gh','Azali','ahmad_bingh@yahoo.co.my',7348292313,959,TO_DATE('14-MAY-10', 'DD-MON-YY'),'abingh','M');
Insert into ONLINE_CUSTOMER (CUSTOMER_ID,CUSTOMER_FNAME,CUSTOMER_LNAME,CUSTOMER_EMAIL,CUSTOMER_PHONE,ADDRESS_ID,CUSTOMER_CREATION_DATE,CUSTOMER_USERNAME,CUSTOMER_GENDER) values (52,'Suchirithaa','Ekanayake','suchiritha@msn.com',6538525924,960,TO_DATE('15-NOV-16', 'DD-MON-YY'),'sekanayake','F');

Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10001,1,TO_DATE('11-JUN-06', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('11-JUN-06', 'DD-MON-YY'),TO_DATE('11-JUN-06', 'DD-MON-YY'),50001);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10002,2,TO_DATE('13-JUN-07', 'DD-MON-YY'),'Shipped','Cash',TO_DATE('13-JUN-07', 'DD-MON-YY'),TO_DATE('13-JUN-07', 'DD-MON-YY'),50001);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10003,5,TO_DATE('17-JUN-08', 'DD-MON-YY'),'Shipped','Cash',TO_DATE('17-JUN-08', 'DD-MON-YY'),TO_DATE('17-JUN-08', 'DD-MON-YY'),50001);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10004,5,TO_DATE('17-APR-10', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('17-APR-10', 'DD-MON-YY'),TO_DATE('17-APR-10', 'DD-MON-YY'),50001);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10005,5,TO_DATE('18-JUL-11', 'DD-MON-YY'),'In process','Credit Card',TO_DATE('18-JUL-11', 'DD-MON-YY'),null,50002);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10006,6,TO_DATE('13-MAR-09', 'DD-MON-YY'),'Shipped','Net Banking',TO_DATE('13-MAR-09', 'DD-MON-YY'),TO_DATE('15-MAR-09', 'DD-MON-YY'),50003);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10007,3,TO_DATE('25-MAR-09', 'DD-MON-YY'),'Shipped','Cash',TO_DATE('25-MAR-09', 'DD-MON-YY'),TO_DATE('25-MAR-09', 'DD-MON-YY'),50004);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10008,7,TO_DATE('16-APR-09', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('16-APR-09', 'DD-MON-YY'),TO_DATE('18-APR-09', 'DD-MON-YY'),50002);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10009,4,TO_DATE('18-NOV-09', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('18-NOV-09', 'DD-MON-YY'),TO_DATE('19-NOV-09', 'DD-MON-YY'),50003);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10010,6,TO_DATE('03-FEB-10', 'DD-MON-YY'),'Shipped','Cash',TO_DATE('05-FEB-10', 'DD-MON-YY'),TO_DATE('05-FEB-10', 'DD-MON-YY'),50004);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10011,1,TO_DATE('19-JUL-10', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('19-JUL-10', 'DD-MON-YY'),TO_DATE('21-JUL-10', 'DD-MON-YY'),50001);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10012,2,TO_DATE('24-JAN-11', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('24-JAN-11', 'DD-MON-YY'),TO_DATE('25-JAN-11', 'DD-MON-YY'),50004);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10013,8,TO_DATE('16-AUG-11', 'DD-MON-YY'),'Cancelled',null,null,null,null);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10014,9,TO_DATE('01-SEP-11', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('01-SEP-11', 'DD-MON-YY'),TO_DATE('03-SEP-11', 'DD-MON-YY'),50005);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10015,10,TO_DATE('23-OCT-11', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('23-OCT-11', 'DD-MON-YY'),TO_DATE('25-OCT-11', 'DD-MON-YY'),50003);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10016,8,TO_DATE('28-OCT-11', 'DD-MON-YY'),'Shipped','Cash',TO_DATE('29-OCT-11', 'DD-MON-YY'),TO_DATE('29-OCT-11', 'DD-MON-YY'),50004);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10017,6,TO_DATE('01-NOV-11', 'DD-MON-YY'),'Shipped','Cash',TO_DATE('03-NOV-11', 'DD-MON-YY'),TO_DATE('03-NOV-11', 'DD-MON-YY'),50004);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10018,11,TO_DATE('15-NOV-11', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('15-NOV-11', 'DD-MON-YY'),TO_DATE('17-NOV-11', 'DD-MON-YY'),50001);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10019,12,TO_DATE('03-DEC-11', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('03-DEC-11', 'DD-MON-YY'),TO_DATE('05-DEC-11', 'DD-MON-YY'),50002);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10020,18,TO_DATE('01-MAR-12', 'DD-MON-YY'),'In process','Net Banking',TO_DATE('01-MAR-12', 'DD-MON-YY'),null,50003);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10021,25,TO_DATE('24-SEP-12', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('26-SEP-12', 'DD-MON-YY'),TO_DATE('28-SEP-12', 'DD-MON-YY'),50006);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10022,23,TO_DATE('12-FEB-13', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('12-FEB-13', 'DD-MON-YY'),TO_DATE('14-FEB-13', 'DD-MON-YY'),50006);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10023,36,TO_DATE('09-SEP-10', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('09-SEP-10', 'DD-MON-YY'),TO_DATE('11-SEP-10', 'DD-MON-YY'),50002);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10024,32,TO_DATE('05-FEB-16', 'DD-MON-YY'),'Shipped','Net Banking',TO_DATE('05-FEB-16', 'DD-MON-YY'),TO_DATE('06-FEB-16', 'DD-MON-YY'),50005);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10025,28,TO_DATE('07-JAN-10', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('09-JAN-10', 'DD-MON-YY'),TO_DATE('12-JAN-10', 'DD-MON-YY'),50001);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10026,21,TO_DATE('03-APR-16', 'DD-MON-YY'),'In process','Net Banking',TO_DATE('05-APR-16', 'DD-MON-YY'),null,null);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10027,23,TO_DATE('01-MAR-13', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('02-MAR-13', 'DD-MON-YY'),TO_DATE('05-MAR-13', 'DD-MON-YY'),50001);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10028,23,TO_DATE('05-MAR-13', 'DD-MON-YY'),'In process','Credit Card',TO_DATE('06-MAR-13', 'DD-MON-YY'),null,null);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10029,25,TO_DATE('21-SEP-12', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('23-SEP-12', 'DD-MON-YY'),TO_DATE('25-SEP-12', 'DD-MON-YY'),50003);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10030,52,TO_DATE('12-DEC-16', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('14-DEC-16', 'DD-MON-YY'),TO_DATE('15-DEC-16', 'DD-MON-YY'),50006);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10031,33,TO_DATE('02-FEB-15', 'DD-MON-YY'),'Cancelled',null,null,null,null);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10032,7,TO_DATE('27-JUN-17', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('27-JUN-07', 'DD-MON-YY'),TO_DATE('29-JUN-07', 'DD-MON-YY'),50003);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10033,28,TO_DATE('01-DEC-11', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('02-DEC-09', 'DD-MON-YY'),TO_DATE('04-DEC-09', 'DD-MON-YY'),50002);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10034,19,TO_DATE('09-APR-12', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('11-APR-12', 'DD-MON-YY'),TO_DATE('13-APR-12', 'DD-MON-YY'),50001);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10035,24,TO_DATE('07-APR-10', 'DD-MON-YY'),'Shipped','Net Banking',TO_DATE('08-APR-10', 'DD-MON-YY'),TO_DATE('10-APR-10', 'DD-MON-YY'),50004);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10036,24,TO_DATE('26-JAN-10', 'DD-MON-YY'),'Shipped','Cash',TO_DATE('27-JAN-10', 'DD-MON-YY'),TO_DATE('28-JAN-10', 'DD-MON-YY'),50001);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10037,2,TO_DATE('24-JUN-11', 'DD-MON-YY'),'Shipped','Cash',TO_DATE('26-JUN-01', 'DD-MON-YY'),TO_DATE('27-JUN-01', 'DD-MON-YY'),50005);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10038,46,TO_DATE('09-JAN-17', 'DD-MON-YY'),'Shipped','Net Banking',TO_DATE('10-JAN-17', 'DD-MON-YY'),TO_DATE('13-JAN-17', 'DD-MON-YY'),50005);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10039,14,TO_DATE('01-MAR-12', 'DD-MON-YY'),'Shipped','Net Banking',TO_DATE('03-MAR-12', 'DD-MON-YY'),TO_DATE('06-MAR-12', 'DD-MON-YY'),50005);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10040,3,TO_DATE('01-AUG-12', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('02-AUG-02', 'DD-MON-YY'),TO_DATE('05-AUG-02', 'DD-MON-YY'),50005);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10041,51,TO_DATE('11-JUN-10', 'DD-MON-YY'),'Cancelled',null,null,null,null);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10042,26,TO_DATE('24-MAR-10', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('26-MAR-10', 'DD-MON-YY'),TO_DATE('29-MAR-10', 'DD-MON-YY'),50004);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10043,17,TO_DATE('13-APR-12', 'DD-MON-YY'),'Shipped','Net Banking',TO_DATE('14-APR-12', 'DD-MON-YY'),TO_DATE('16-APR-12', 'DD-MON-YY'),50002);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10044,39,TO_DATE('04-JUN-16', 'DD-MON-YY'),'In process','Net Banking',TO_DATE('04-JUN-06', 'DD-MON-YY'),null,null);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10045,34,TO_DATE('31-DEC-15', 'DD-MON-YY'),'In process','Credit Card',TO_DATE('02-JAN-16', 'DD-MON-YY'),null,null);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10046,3,TO_DATE('11-SEP-12', 'DD-MON-YY'),'Shipped','Net Banking',TO_DATE('13-SEP-02', 'DD-MON-YY'),TO_DATE('16-SEP-02', 'DD-MON-YY'),50002);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10047,24,TO_DATE('18-FEB-10', 'DD-MON-YY'),'Shipped','Net Banking',TO_DATE('18-FEB-10', 'DD-MON-YY'),TO_DATE('19-FEB-10', 'DD-MON-YY'),50005);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10048,33,TO_DATE('02-FEB-15', 'DD-MON-YY'),'Shipped','Cash',TO_DATE('03-FEB-15', 'DD-MON-YY'),TO_DATE('05-FEB-15', 'DD-MON-YY'),50002);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10049,33,TO_DATE('04-FEB-15', 'DD-MON-YY'),'In process','Credit Card',TO_DATE('05-FEB-15', 'DD-MON-YY'),null,null);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10050,1,TO_DATE('15-JUL-15', 'DD-MON-YY'),'In process','Net Banking',TO_DATE('16-JUL-91', 'DD-MON-YY'),null,null);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10051,43,TO_DATE('23-MAY-14', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('24-MAY-14', 'DD-MON-YY'),TO_DATE('26-MAY-14', 'DD-MON-YY'),50006);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10052,17,TO_DATE('04-MAY-12', 'DD-MON-YY'),'In process',null,null,null,null);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10053,40,TO_DATE('26-DEC-16', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('26-DEC-16', 'DD-MON-YY'),TO_DATE('29-DEC-16', 'DD-MON-YY'),50005);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10054,19,TO_DATE('25-JUN-12', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('26-JUN-12', 'DD-MON-YY'),TO_DATE('29-JUN-12', 'DD-MON-YY'),50004);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10055,25,TO_DATE('19-SEP-12', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('21-SEP-12', 'DD-MON-YY'),TO_DATE('23-SEP-12', 'DD-MON-YY'),50006);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10056,11,TO_DATE('12-FEB-12', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('13-FEB-12', 'DD-MON-YY'),TO_DATE('15-FEB-12', 'DD-MON-YY'),50004);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10057,11,TO_DATE('07-DEC-11', 'DD-MON-YY'),'Shipped','Cash',TO_DATE('07-DEC-11', 'DD-MON-YY'),TO_DATE('10-DEC-11', 'DD-MON-YY'),50005);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10058,28,TO_DATE('20-DEC-17', 'DD-MON-YY'),'In process',null,null,null,null);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10059,30,TO_DATE('01-AUG-11', 'DD-MON-YY'),'Shipped','Net Banking',TO_DATE('02-AUG-91', 'DD-MON-YY'),TO_DATE('05-AUG-91', 'DD-MON-YY'),50001);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10060,50,TO_DATE('13-MAR-13', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('14-MAR-13', 'DD-MON-YY'),TO_DATE('15-MAR-13', 'DD-MON-YY'),50005);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10061,37,TO_DATE('03-AUG-12', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('03-AUG-12', 'DD-MON-YY'),TO_DATE('05-AUG-12', 'DD-MON-YY'),50001);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10062,34,TO_DATE('04-DEC-15', 'DD-MON-YY'),'Cancelled',null,null,null,null);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10063,18,TO_DATE('21-MAR-12', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('23-MAR-12', 'DD-MON-YY'),TO_DATE('25-MAR-12', 'DD-MON-YY'),50001);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10064,35,TO_DATE('21-MAR-14', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('21-MAR-14', 'DD-MON-YY'),TO_DATE('22-MAR-14', 'DD-MON-YY'),50004);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10065,17,TO_DATE('08-MAR-12', 'DD-MON-YY'),'In process','Net Banking',TO_DATE('08-MAR-12', 'DD-MON-YY'),null,null);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10066,41,TO_DATE('21-DEC-17', 'DD-MON-YY'),'Cancelled',null,null,null,null);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10067,6,TO_DATE('17-MAY-16', 'DD-MON-YY'),'In process','Credit Card',TO_DATE('18-MAY-06', 'DD-MON-YY'),null,null);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10068,51,TO_DATE('11-JUL-10', 'DD-MON-YY'),'Shipped','Credit Card',TO_DATE('12-JUL-10', 'DD-MON-YY'),TO_DATE('14-JUL-10', 'DD-MON-YY'),50004);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10069,23,TO_DATE('03-MAR-13', 'DD-MON-YY'),'Shipped','Net Banking',TO_DATE('03-MAR-13', 'DD-MON-YY'),TO_DATE('05-MAR-13', 'DD-MON-YY'),50002);
Insert into ORDER_HEADER (ORDER_ID,CUSTOMER_ID,ORDER_DATE,ORDER_STATUS,PAYMENT_MODE,PAYMENT_DATE,ORDER_SHIPMENT_DATE,SHIPPER_ID) values (10070,10,TO_DATE('05-NOV-11', 'DD-MON-YY'),'Shipped','Net Banking',TO_DATE('05-NOV-11', 'DD-MON-YY'),TO_DATE('07-NOV-11', 'DD-MON-YY'),50001);
...
(
SELECT SUM(product.len * product.width * product.height * order_items.product_quantity)
FROM order_items
JOIN product
...
--Q2 Write a query to display details (customer id,customer fullname,order id,product quantity) of customers who bought more than ten (i.e. total order qty) products per shipped order. [NOTE: TABLES TO BE USED - online_customer, order_header, order_items,]
...
--Q3 Write a query to display the order_id, customer id and cutomer full name of customers along with (product_quantity) as total quantity of products shipped for order ids > 10060. [NOTE: TABLES TO BE USED - online_customer, order_header, order_items]
...
--Q4 Write a query to display product class description ,total quantity (sum(product_quantity),Total value (product_quantity * product price) and show which class of products have been shipped highest(Quantity) to countries outside India other than USA? Also show the total value of those items. NOTE:PRODUCT TABLE,ADDRESS TABLE,ONLINE_CUSTOMER TABLE,ORDER_HEADER TABLE,ORDER_ITEMS TABLE,PRODUCT_CLASS TABLE]
